...
BOT_TOKEN = environ.get('BOT_TOKEN', "7646618066:AAGRtXuLiuS-8-j1-PRIWkiVvauI1jQ20mw")
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1001981325348').split()]
MAX_B_TN = environ.get("MAX_B_TN", "7")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Netflix_MV_Group')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Movies_Request_MV')
