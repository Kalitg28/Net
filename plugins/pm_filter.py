...
async def pm_text(bot, message):
    ...
    if await db.get_setting("PM_FILTER", default=PM_FILTER) or await db.has_premium_access(message.from_user.id):
        ...
        await message.reply_text("<b>🙋 ʜᴇʏ {} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ ᴏɴʟʏ ꜱᴇᴀʀᴄʜ ꜰᴏʀ ᴍᴏᴠɪᴇꜱ ɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ. ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀʟʟᴏᴡᴇᴅ ᴛᴏ ꜱᴇᴀʀᴄʜ ꜰᴏʀ ᴍᴏᴠɪᴇꜱ ɪɴ ᴅɪʀᴇᴄᴛ ʙᴏᴛ. ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴛʜᴇ Gʀᴏᴜᴘ Hᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴀɴᴅ ꜱᴇᴀʀᴄʜ ꜰᴏʀ ʏᴏᴜʀ ꜰᴀᴠᴏʀɪᴛᴇ ᴍᴏᴠɪᴇ ᴛʜᴇʀᴇ.👇\n\n<blockquote>எங்கள் மூவி குரூப்பில் மட்டுமே நீங்கள் திரைப்படங்களைத் தேட முடியும். Direct Bot இல் திரைப்படங்களைத் தேட உங்களுக்கு அனுமதி இல்லை. கீழே கொடுக்கப்பட்டுள்ள Gʀᴏᴜᴘ Hᴇʀᴇ என்ற பொத்தானைக் கிளிக் செய்வதன் மூலம் எங்கள் மூவி குழுவில் சேரவும், உங்களுக்குப் பிடித்த திரைப்படத்தை அங்கு தேடவும்.</blockquote></b>", reply_markup=InlineKeyboardMarkup([
